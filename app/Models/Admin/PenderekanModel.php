...
class PenderekanModel extends Model
{
    ...
    protected $allowedFields    = ['ukpd_id', 'bap_id', 'tanggal_penderekan', 'jam_penderekan', 'jenis_pelanggaran_id', 'tempat_penyimpanan_kendaraan_id'];
