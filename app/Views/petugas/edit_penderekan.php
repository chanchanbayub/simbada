    ...
    <div class="card-body">
        <form id="form_penderekan" autocomplete="off">
            ...
            <div class="modal-footer">
                <a href="/petugas/data_penderekan" type="button" class="btn btn-danger"> <i class="fa fa-times"></i> Batal</a>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.error) {
                        ...
                        setTimeout(function() {
                            document.location.href = '/petugas/data_penderekan';
                        }, 1500);
                    }
                },
                error: function() {
