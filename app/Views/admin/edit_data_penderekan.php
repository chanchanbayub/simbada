...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary"> Form Edit Penderekan</h6>
    </div>
    <div class="card-body">
        <form id="form_penderekan" autocomplete="off">
            <?= csrf_field(); ?>
            <div class="form-group">
                <input type="hidden" class="form-control" id="fotoLama" name="fotoLama" value="<?= $penderekan["foto"] ?>">
                <input type="hidden" class="form-control" id="mimeLama" name="mimeLama" value="<?= $penderekan["mime"] ?>">
                <input type="hidden" class="form-control" id="ttd_digital" name="ttd_digital" value="<?= $penderekan["ttd_digital"] ?>">
                <input type="hidden" class="form-control" id="id" name="id" value="<?= $penderekan["id"] ?>">
            </div>
            <div class=" form-group">
                <input type="hidden" class="form-control" id="bap_id" name="bap_id" value="<?= $penderekan["bap_id"] ?>">
            </div>
            <div class="form-group">
                <input type="hidden" class="form-control" id="ukpd_id" name="ukpd_id" value="<?= $penderekan["ukpd_id"] ?>">
            </div>
            <div class="form-group">
                <label for="ukpd">UKPD :</label>
                <input type="text" class="form-control" id="ukpd" name="ukpd" value="<?= session('ukpd') ?>" disabled>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="jenis_kendaraan_id" name="jenis_kendaraan_id" style="width:100% ;">
                    ...
                    <?php foreach ($jenis_kendaraan as $jenis_kendaraan) : ?>
                        <?php if ($jenis_kendaraan["id"] == $penderekan["jenis_kendaraan_id"]) : ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="klasifikasi_kendaraan_id" name="klasifikasi_kendaraan_id" style="width:100% ;">
                    <option value="">--Silahkan Pilih--</option>
                    <?php foreach ($klasifikasi_kendaraan as $klasifikasi_kendaraan) : ?>
                        <?php if ($penderekan["klasifikasi_kendaraan_id"] == $klasifikasi_kendaraan["id"]) : ?>
                            <option value="<?= $klasifikasi_kendaraan["id"] ?>" selected><?= $klasifikasi_kendaraan["klasifikasi_kendaraan"] ?></option>
                        <?php else : ?>
                            <option value="<?= $klasifikasi_kendaraan["id"] ?>"><?= $klasifikasi_kendaraan["klasifikasi_kendaraan"] ?></option>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="type_kendaraan_id" name="type_kendaraan_id" style="width:100% ;">
                    <option value="">--Silahkan Pilih--</option>
                    <?php foreach ($type_kendaraan as $type_kendaraan) : ?>
                        <?php if ($penderekan["type_kendaraan_id"] == $type_kendaraan["id"]) : ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="merk_kendaraan" name="merk_kendaraan" value="<?= $penderekan["merk_kendaraan"] ?>">
                <div id="error_merk_kendaraan" class="invalid-feedback">
                </div>
            </div>
            <div class=" form-group">
                <label for="nomor_kendaraan">Nomor Kendaraan :</label>
                <input type="text" class="form-control" id="nomor_kendaraan" name="nomor_kendaraan" value="<?= $penderekan["nomor_kendaraan"] ?>">
                <div id="error_nomor_kendaraan" class="invalid-feedback">
                </div>
            </div>
            <div class=" form-group">
                <label for="warna_kendaraan">Warna Kendaraan :</label>
                <input type="text" class="form-control" id="warna_kendaraan" name="warna_kendaraan" value="<?= $penderekan["warna_kendaraan"] ?>">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="jenis_pelanggaran_id" name="jenis_pelanggaran_id" style="width:100% ;">
                    ...
                    <?php foreach ($jenis_pelanggaran as $jenis_pelanggaran) : ?>
                        <?php if ($penderekan["jenis_pelanggaran_id"] == $jenis_pelanggaran["id"]) : ?>
                            <option value="<?= $jenis_pelanggaran["id"] ?>" selected><?= $jenis_pelanggaran["keterangan"] ?></option>
                        <?php else : ?>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="tanggal_penderekan" name="tanggal_penderekan" value="<?= $penderekan["tanggal_penderekan"] ?>">
                <div id="error_tanggal_penderekan" class="invalid-feedback">
                </div>
            </div>
            <div class="form-group">
                <label for="jam_penderekan">Jam Penderekan :</label>
                <input type="time" class="form-control" id="jam_penderekan" name="jam_penderekan" value="<?= $penderekan["jam_penderekan"] ?>">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="provinsi_id" name="provinsi_id" style="width:100% ;">
                    ...
                    <?php foreach ($provinsi as $provinsi) : ?>
                        <?php if ($penderekan["provinsi_id"] == $provinsi["id"]) : ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="kota_id" name="kota_id" style="width:100% ;">
                    <option value="">--Silahkan Pilih--</option>
                    <?php foreach ($kota as $kota) : ?>
                        <?php if ($penderekan["kota_id"] == $kota["id"]) : ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="kecamatan_id" name="kecamatan_id" style="width:100% ;">
                    <option value="">--Silahkan Pilih--</option>
                    <?php foreach ($kecamatan as $kecamatan) : ?>
                        <?php if ($penderekan["kecamatan_id"] == $kecamatan["id"]) : ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="kelurahan_id" name="kelurahan_id" style="width:100% ;">
                    <option value="">--Silahkan Pilih--</option>
                    <?php foreach ($kelurahan as $kelurahan) : ?>
                        <?php if ($penderekan["kelurahan_id"] == $kelurahan["id"]) : ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_jalan" name="nama_jalan" value="<?= $penderekan["nama_jalan"] ?>">
                <div id="error_nama_jalan" class="invalid-feedback">
                </div>
            </div>
            <div class="form-group">
                <label for="nama_gedung">Lokasi Penderekan (Nama Gedung) (opsional) :</label>
                <input type="text" class="form-control" id="nama_gedung" name="nama_gedung" value="<?= $penderekan["nama_gedung"] ?>">
                <div id="error_nama_gedung" class="invalid-feedback">
                </div>
            </div>
            <div class="form-group">
                <label for="nomor_identitas_pengemudi">KTP / SIM / PASPOR Pengemudi :</label>
                <input type="text" class="form-control" id="nomor_identitas_pengemudi" name="nomor_identitas_pengemudi" value="<?= $penderekan["nomor_identitas_pengemudi"] ?>">
                <div id="error_nomor_identitas_pengemudi" class="invalid-feedback">
                </div>
            </div>
            <div class="form-group">
                <label for="nama_pengemudi">Nama Pengemudi :</label>
                <input type="text" class="form-control" id="nama_pengemudi" name="nama_pengemudi" value="<?= $penderekan["nama_pengemudi"] ?>">
                <div id="error_nama_pengemudi" class="invalid-feedback">
                </div>
            </div>
            <div class="form-group">
                <label for="alamat_pengemudi">Alamat Pengemudi :</label>
                <input type="text" class="form-control" id="alamat_pengemudi" name="alamat_pengemudi" value="<?= $penderekan["alamat_pengemudi"] ?>">
                <div id="error_alamat_pengemudi" class="invalid-feedback">
                </div>
            </div>
            <div class="form-group">
                <label for="nomor_handphone_pengemudi">Nomor Handphone Pengemudi :</label>
                <input type="text" class="form-control" id="nomor_handphone_pengemudi" name="nomor_handphone_pengemudi" value="<?= $penderekan["nomor_handphone_pengemudi"] ?>">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="tempat_penyimpanan_kendaraan_id" name="tempat_penyimpanan_kendaraan_id" style="width:100% ;">
                    ...
                    <?php foreach ($tempat_penyimpanan as $tempat_penyimpanan) : ?>
                        <?php if ($penderekan["tempat_penyimpanan_kendaraan_id"] == $tempat_penyimpanan["id"]) : ?>
...
<div class="modal fade bd-example-modal-lg" id="syarat_dan_ketentuan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="signature">
                    <img src="/<?= $penderekan["ttd_digital"] ?>" alt="tanda_tangan_digital" disabled>
                    <!-- <div id="canva"></div>
                    <div class="text-left">
    ...
    <script>
        ...
        $("#jenis_kendaraan_id").change(function(e) {
            ...
            let id = $(this).val();
            $.ajax({
                url: '/admin/penderekan/getKlasifikasi',
                type: 'get',
                data: {
        ...
        $("#klasifikasi_kendaraan_id").change(function(e) {
            ...
            $.ajax({
                url: '/admin/penderekan/getTypeKendaraan',
                type: 'get',
                data: {
        ...
        $("#kota_id").change(function(e) {
            ...
            $.ajax({
                url: '/admin/penderekan/getKecamatan',
                type: 'get',
                data: {
                    kota_id: id
                },
        ...
        $("#kecamatan_id").change(function(e) {
            ...
            $.ajax({
                url: '/admin/penderekan/getKelurahan',
                type: 'get',
                data: {
                    kecamatan_id: id
                },
        ...
        $("#form_penderekan").submit(function(e) {
            ...
            let mimeLama = $("#mimeLama").val();
            let ttd_digital = $("#ttd_digital").val();
            let id = $('#id').val();
            ...
            formData.append('ttd_digital', ttd_digital);
            formData.append('id', id);
            formData.append('fotoLama', fotoLama);
            formData.append('mimeLama', mimeLama);
            ...
            $("#syarat_dan_ketentuan").on('click', '#send', function(e) {
                e.preventDefault();
                sendData(formData);
            });
        });
                ...
                success: function(response) {
                    ...
                    if (response.error) {
                        ...
                        if (response.error.tempat_penyimpanan_kendaraan_id) {
                            ...
                            $("#error_tempat_penyimpanan_kendaraan_id").html(response.error.tempat_penyimpanan_kendaraan_id);
                        } else {
                            $("#tempat_penyimpanan_kendaraan_id").removeClass('is-invalid');
                            $("#error_tempat_penyimpanan_kendaraan_id").html('');
                        }
                        ...
                        setTimeout(function() {
                            document.location.href = '/admin/penderekan';
                        }, 1500);
                    }
                },
                error: function() {
